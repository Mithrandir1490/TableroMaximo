...
# ---------------------------------------------------------
# 2. MOTOR DE EXTRACCIÓN Y CÁLCULO DE BLOQUES
# ---------------------------------------------------------
...
def cargar_datos_universo():
    ...
    for item in UNIVERSO:
        ...
        try:
            ...
            # --- TRATAMIENTO DE CRIPTO & COMMODITIES ---
            ...
            # --- BLOQUE 4: CRECIMIENTO FUNDAMENTAL (EPS & VENTAS) ---
            ...
            # SCORE PONDERADO DE WALL STREET (30% B4, 25% B5, 20% B3, 15% B2, 10% B1)
            score_total = (
                (upside_b4 * 0.30) +
                (upside_b5 * 0.25) +
                (upside_b3 * 0.20) +
